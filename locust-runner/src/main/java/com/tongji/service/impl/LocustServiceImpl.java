...
public class LocustServiceImpl implements LocustService {
    ...
    @Async
    @Override
    public void runWorkLoad(LocustParam locustParam, String account, String taskName) throws Exception {

        locustMapper.InsertOwns(account, String.valueOf(args.REPORTID));
        locustMapper.InsertTaskName(String.valueOf(args.REPORTID), taskName);
    ...
    public String getLocustResultStream(String from, String to) throws Exception {
        ...
        for (LocustResult result : locustResultList) {
            ...
            stringBuilder.append(simpleDateFormat.format(result.getDateTime())).append("\n");
        }
